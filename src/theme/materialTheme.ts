...
export const shadows = {
  ...
  24: '0 9px 12px -6px rgba(0,0,0,0.2), 0 24px 38px 3px rgba(0,0,0,0.14), 0 9px 46px 8px rgba(0,0,0,0.12)',
}
...
export const transitions = {
  ...
  leave: 'all 200ms cubic-bezier(0.4, 0, 1, 1)',
}
